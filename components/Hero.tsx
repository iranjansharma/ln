    ...
    <div className="container h-screen mx-auto md:py-20 lg:py-40 relative z-10">
      <div className="mb-6 sm:mb-8 md:mb-10 flex justify-center">
        ...
        >
          ...
          >
            ...
            <span className="hidden sm:inline-flex items-center">Github</span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
      ...
      <div className="mb-6 sm:mb-8">
        ...
        <BlurText
          ...
          animateBy="words"
          direction="top"
          className="text-3xl text-white font-normal mb-8 flex px-4 justify-center items-center"
        />
      </div>
      <BlurText
        ...
        animateBy="words"
        direction="top"
        className="text-base mx-auto md:w-1/3 text-white mb-8 px-4 flex justify-center items-center"
      />
